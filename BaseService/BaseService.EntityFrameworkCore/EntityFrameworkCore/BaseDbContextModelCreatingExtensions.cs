    ...
    public static class BaseDbContextModelCreatingExtensions
    {
        public static void ConfigureBaseService(this ModelBuilder builder)
        {
            ...
            builder.Entity<Menu>(b =>
            {
                ...
                b.Property(x => x.Title).HasMaxLength(BaseServiceConsts.MaxFullNameLength);
            ...
            builder.Entity<Company>(b =>
            {
                ...
                b.Property(x => x.CompanyCode).HasMaxLength(200);
                b.Property(x => x.CompanyName).HasMaxLength(200);
                b.Property(x => x.Remarks).HasMaxLength(2000);
                b.Property(x => x.Enabled).IsRequired();
                b.Property(x => x.RestartReason).IsRequired().HasMaxLength(200);
            });

            builder.Entity<UserCompany>(b =>
            {
                b.ToTable("base_user_companys");

                b.HasKey(k => new { k.UserId, k.CompanyId });
            });
        }
    }
}
