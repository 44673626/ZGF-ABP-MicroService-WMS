using Com.ApolloConfig.ApolloCS;
...
namespace Com.ApolloConfig
{
    public static class ApolloConfigurationExtension
    {
        ...
        private static void AddConfigurationApollo(this IConfigurationBuilder builder, string jsonPath)
        {
        ...
        public static IHostBuilder UseApollo(this IHostBuilder builder)
        {
            ...
            return builder
                .ConfigureAppConfiguration((config) =>
                {
                    ...
                    {
                        config.AddConfigurationApollo(apolloJsonName);
                    }
                    else
                    {
