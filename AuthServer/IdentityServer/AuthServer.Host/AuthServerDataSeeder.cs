    ...
    public class AuthServerDataSeeder : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            await CreateClientAsync(
               ...
               scopes: new[] { "InternalGateway", "IdentityService", "BaseService",
                   "FileStorageService", "BusinessService" },
               grantTypes: new[] { "client_credentials" },
               secret: "1q2w3e*".Sha256(),
               permissions: new[] { IdentityPermissions.Users.Default,
                   IdentityPermissions.UserLookup.Default, "FileStorage.UploadFile", "FileStorage.UploadFile.Create" }
            );
            await CreateClientAsync(
                   name: "blazor-app",
