    ...
    <div class="field-box">
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          <el-form-item v-if="activeData.changeTag" label="组件类型">
            ...
            >
              <el-option-group v-for="group in tagList" :key="group.label" :label="group.label">
                ...
                >
                  <svg-icon class="node-icon" :icon-class="item.fieldType" />
          ...
          <el-form-item v-if="activeData.fieldName!==undefined" label="默认值">
            <el-input
          ...
          <template v-if="['el-cascader'].indexOf(activeData.tag) > -1">
            ...
            <el-tree
              ...
              node-key="id"
              :expand-on-click-node="true" highlight-current
          ...
          <el-form-item v-if="activeData.isReadonly !== undefined" label="是否只读">
            <el-switch v-model="activeData.isReadonly" />
          </el-form-item>
            ...
            >
              <span slot-scope="{ node, data }">
                <span class="node-label">
                  <svg-icon class="node-icon" :icon-class="data.fieldType" />
                  {{ node.label }}
                </span>
              </span>
            </el-tree>
...
export default {
  ...
  data() {
    return {
      ...
      layoutTreeProps: {
        label(data, node) {
          return data.componentName || `${data.label}: ${data.fieldName}`
        }
      }
    }
  },
